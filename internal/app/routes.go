...
func (a *App) RegisterRoutes() *gin.Engine {
	...
	v1 := router.Group("/api/v1")
	{
		...
		tasks.Use(middleware.Authenticate(a.jwt))
		{
			...
			tasks.POST("/instances/:task_instance_id/dependencies", a.HandleCreateTaskInstanceDependency)
			tasks.GET("/instances/:task_instance_id/dependencies", a.HandleListTaskInstanceDependencies)
			tasks.GET("/instances/:task_instance_id/dependents", a.HandleListTaskInstanceDependents)
